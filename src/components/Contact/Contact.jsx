...
const socialLinks = [
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/martha-neelima-75125125a/",
    icon: (
  ...
  },
  {
    ...
    url: /Mobi|Android/i.test(navigator.userAgent)
      ? "mailto:marthaneelima3@gmail.com?subject=Portfolio%20Inquiry"
      : "https://mail.google.com/mail/?view=cm&fs=1&to=marthaneelima3@gmail.com&su=Portfolio%20Inquiry",
    icon: (
